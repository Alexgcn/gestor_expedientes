...
const renderRecord = async (id) => {
    ...
    jurisdiction.textContent = "Grupo: "+record.juzgado.circunscripcion.nombre;
    court.textContent = "Area: "+record.juzgado.nombre;
    order.textContent = "Personas a participar: "+record.orden;
    secretary.textContent = "Identificador: "+record.secretario;
